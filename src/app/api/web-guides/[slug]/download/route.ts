...
// this endpoint just fetches, swaps the watermark placeholder, and
// streams. CPU budget on Workers Paid is plenty for the substitution.
//
...
import { applyWatermark, downloadFilenameFor } from '@/lib/web-guide-download'
...
export async function GET(
  ...
  // ── Authorise + resolve buyer email for the watermark ──
  ...
  // ── Fetch pre-baked HTML from Supabase, apply watermark, stream ──
